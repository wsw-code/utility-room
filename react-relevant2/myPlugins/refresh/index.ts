...
import refreshBabel from '../utils/babel'
...
export default function viteReact(opts: Options = {}): PluginOption[] {
  ...
  const viteBabel: Plugin = {
    ...
    configResolved(config) {
      ...
      projectRoot = config.root // D:/utility-room/react-relevant2
      ...
      skipFastRefresh =
        ...
        // console.log(process.env.TEST,process.env.VITE_TEST_HMR)  undefinded undefinded
